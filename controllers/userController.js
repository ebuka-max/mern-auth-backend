...
const sendLoginCode = asyncHandler(async (req, res) => {
    ...
    // Send Login Code
    const subject = "Login Access Code - AUTH:J"
    const send_to = email
...
const forgotPassword = asyncHandler(async (req, res) => {
    ...
    // Send email
    const subject = "Password Reset Request - AUTH:J"
    const send_to = user.email
    const sent_from = process.env.EMAIL_USER
    const reply_to = "noreply@John.com"
...
module.exports = { registerUser, loginUser, logoutUser, getUser, updateUser, deleteUser, getUsers, loginStatus, upgradeUser, sendAutomatedEmail, sendVerificationEmail, verifyUser, forgotPassword, resetPassword, changePassword, sendLoginCode, loginWithCode, loginWithGoogle }